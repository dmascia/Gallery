      ...
      <div className="grid md:grid-cols-2">
        <div className="flex flex-col items-center justify-center bg-white">
          <div className="max-w-lg px-5 py-16 text-center md:px-10 md:py-24 lg:py-32">
            <h2 className="mb-8 text-3xl font-bold md:mb-12 md:text-5xl">Start Interacting Today!</h2>
            <SignUpForm />
            <p className="text-sm text-[#636262]">Already have an account? <a href="#" className="text-sm font-bold text-black">Login now</a>
            </p>
          </div>
        </div>
